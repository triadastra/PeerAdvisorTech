...
// that owns each one.
export const agents = [
  { id: 'super-relay', name: 'Super Relay™', spec: 3, scope: 'Routing · 8 providers', status: 'live', metric: '99.9%' },
  { id: 'synonance-rag', name: 'Synonance RAG', spec: 2, scope: 'Retrieval pipeline', status: 'live', metric: '84%↓ tokens' },
  { id: 'self-healing', name: 'Self-healing ops', spec: 3, scope: 'Infra watchdog', status: 'idle', metric: 'last 02:14' },
  { id: 'intelligence', name: 'Intelligence layer', spec: 3, scope: 'Aggregate reporting', status: 'live', metric: 'min-N floor' },
...
export const milestones = [
  { id: 'm-jun', month: 'Jun', date: '2026-06-16', spec: 3, label: 'Spine hardening', state: 'active' },
  { id: 'm-jul', month: 'Jul', date: '2026-07-15', spec: 3, label: 'Super Relay™ GA', state: 'planned' },
...
export const starterTasks = [
  { title: 'Harden The Spine before Launchpad', spec: 3, priority: 'High' },
  { title: 'Resource isolation for untrusted student code', spec: 4, priority: 'High' },
  { title: 'Refresh Synonance curriculum index', spec: 2, priority: 'Med' },
...
export const starterEvents = [
  { dayOffset: 0, time: '09:30', title: 'Spine hardening review', spec: 3, with_whom: null },
  { dayOffset: 0, time: '14:00', title: 'Launchpad isolation sync', spec: 4, with_whom: 'Jessica' },
  { dayOffset: 1, time: '10:00', title: 'Synonance RAG eval', spec: 2, with_whom: 'Pete' },
