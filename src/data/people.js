...
export const people = [
  ...
  },
  {
    ...
    insights: 'Leads Academy, the retrieval-grounded study assistant.',
  },
  {
    id: 'brian-deng', name: 'Brian Deng', year: '27', avatar: 'BD',
    status: 'active',
    title: 'Data Science & Competition Prep',
    leads: [{ n: 7, role: 'Team' }, { n: 8, role: 'Lead' }],
    insights: 'Builds data-science teaching material and competition-learning resources.',
  },
  {
    ...
    insights: 'Leads Launchpad’s shared data layer.',
  },
  {
