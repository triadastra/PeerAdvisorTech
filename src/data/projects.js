...
export const projects = [
  ...
  // ── PLACEHOLDER ─────────────────────────────────────────────────────────
  // Study remains a placeholder. Session describes its intended platform scope;
  // its delivery status remains Planned. See CONTENT.md.
  {
    id: 'study',
    spec: 9,
    title: 'Study',
  ...
  },
  {
    ...
    spec: 10,
    title: 'Session',
    caption: 'A home for academic labs and startups, with recruiting and scheduling tools.',
    category: 'Platform',
    status: 'Planned',
    bio: 'Session is a platform for hosting academic labs and startups, helping them recruit members and coordinate schedules.',
    techStack: [],
    workDescriptions: [],
  },
];
